...
class AliceCallListItemWidget extends StatelessWidget {
  ...
  const AliceCallListItemWidget(this.call, this.itemClickAction, {Key? key})
      : super(key: key);
    ...
    return Row(
      children: [
        Text(
          ...
          style: TextStyle(
            fontSize: 16,
            color: textColor != AliceConstants.red
                ? _getMethodColor(call.method)
                : AliceConstants.red,
          ),
        ),
        const Padding(
