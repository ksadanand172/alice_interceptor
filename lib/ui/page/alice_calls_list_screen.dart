...
import 'package:alice_interceptor/helper/alice_alert_helper.dart';
import 'package:alice_interceptor/model/alice_http_call.dart';
import 'package:alice_interceptor/model/alice_menu_item.dart';
import 'package:alice_interceptor/model/alice_sort_option.dart';
import 'package:alice_interceptor/ui/page/alice_call_details_screen.dart';
import 'package:alice_interceptor/ui/widget/alice_call_list_item_widget.dart';
...
class AliceCallsListScreen extends StatefulWidget {
  ...
  const AliceCallsListScreen(this._aliceCore, {Key? key}) : super(key: key);
...
class _AliceCallsListScreenState extends State<AliceCallsListScreen> {
  ...
  void _onListItemClicked(AliceHttpCall call) {
    Navigator.push<void>(
      ...
      MaterialPageRoute(
        settings: const RouteSettings(name: "/api_inspector_details"),
