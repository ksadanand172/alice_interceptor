...
import 'package:alice_interceptor/model/alice_form_data_file.dart';
import 'package:alice_interceptor/model/alice_from_data_field.dart';
...
class AliceDioInterceptor extends InterceptorsWrapper {
  ...
  /// Handles dio request and creates dev_interceptor http call based on it
  @override
  ...
  /// Handles dio response and adds data to dev_interceptor http call
  @override
  ...
  /// Handles error and adds data to dev_interceptor http call
  @override
